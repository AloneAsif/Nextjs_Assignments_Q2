        ...
        <div className="grid grid-cols-1 md:grid-cols-2 items-center">
          ...
          >
            <Image
              ...
              src="https://m.media-amazon.com/images/I/51u0BxrM4VL._AC_SY575_.jpg"
              width={300}
              height={300}
              alt="Grey Heron"
            />
          ...
          >
            ...
            <p>
            Woman Necklace Earrings Set Women Fashion Crystal Pendant Jewelry Decor Necklace + Earrings +Two-Piece Suit Elegant Women Jewellery Convenient and clever
            </p>
          </motion.div>
        </div>
